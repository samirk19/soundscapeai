...
def lambda_handler(event, context):
    ...
    try:
        ...
        try:
            ...
            # Start Step Functions execution with the smaller payload
            print(f"Starting Step Functions execution with ARN: {state_machine_arn}")
            ...
            print(f"Step Functions execution started successfully: {response}")
